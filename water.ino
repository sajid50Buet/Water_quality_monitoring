...
String apiKey = "9RY745DHLL9KJPZI";     //  Enter your Write API key from ThingSpeak
 
const char *ssid =  "Dot_theTF";     // replace with your wifi ssid and wpa2 key
const char *pass =  "Saha.69@mf";
